...
<section class="error">
  ...
  <div class="error__content">
    <div class="error__message message">
      <h1 style="color:#08ffff;" class="message__title">Page Not Found</h1>
      <p style="color: bisque;" class="message__text">We're sorry, the page you were looking for isn't found here. The link you followed may either be broken or no longer exists. Turn back to HomePage.</p>
    </div>
    <div class="error__nav e-nav">
      <a style="background-color: cyan;" href="admin.php" target="_blanck" class="e-nav__link"></a>
    </div>
  </div>
  <!-- END Content -->
